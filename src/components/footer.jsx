...
const Footer = () => {
  return (
    <>
      {/* Footer Section */}
      <footer className="p-4" style={{ background: 'linear-gradient(180deg, #000080 0%, #000017 100%)' }}>
        {/* Company Logo Section */}
        <div className="flex flex-col md:flex-row md:justify-between items-start">
          <div className="w-full md:w-1/5 mb-8 md:mb-0 flex flex-col items-center">
            <img src="/images/logo.svg" alt="Company Logo" className="w-138 h-112 mb-4 md:mb-0 mt-16" />
          </div>
          ...
          <div className="w-full md:w-1/5 mb-8 md:mb-0 flex flex-col items-start">
            ...
            <ul className="list-none text-gray-300 py-4 gap-8 text-left">
              <a href=""><li>Resource 1</li></a>
              <a href=""><li>Resource 2</li></a>
              <a href=""><li>Resource 3</li></a>
            </ul>
          </div>
        ...
        {/* VERDEX Section */}
        <div className="w-full md:w-4/5 mx-auto md:flex items-center justify-center mt-8">
