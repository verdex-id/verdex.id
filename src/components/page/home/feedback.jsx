...
export default function HomeFeedback() {
  return (
    <>
      ...
      <div className="bg-gradient-to-b from-navy-900 to-navy-800 text-white p-8 min-h-dvh">
        <div className="grid grid-cols-1 md:grid-cols-2 items-center w-full max-w-screen-xl mx-auto">
          {/* Section Start: Feedback Content */}
          <div className="flex flex-col">
            <div className="mb-8 flex items-center">
              <h1 className="text-4xl md:text-6xl font-bold mb-2 text-left md:mt-12">
                Feedback
              </h1>
              <Image
            ...
            <p className="text-base md:text-lg mb-4 text-left text-paragraph">
              Tulis pengalamanmu di Verdex.id! Ceritakan feedback dan saranmu
              agar Verdex.id semakin baik.
            </p>
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between ">
              <p className="text-sm md:text-base mb-6 text-left text-paragraph md:mr-6 mt-4 md:mt-8">
                Berikanlah kami masukanmu! Kami ingin mendengar langsung dari
                para Verumians mengenai pengalamanmu. Apa yang dapat kami
                perbaiki untuk membuat platform ini lebih baik?
              </p>
